    ...
    <div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="providerName" label="提供商名称" width="120"></el-table-column>
                <el-table-column prop="mchName" label="商户名称" width="120"></el-table-column>
                <el-table-column prop="areaCode" label="区号" width="60"></el-table-column>
                <el-table-column prop="phone" label="手机号" width="120"></el-table-column>
                <el-table-column prop="msgid" label="短信消息id" width="170"></el-table-column>
                ...
                <el-table-column label="状态" align="center" width="120">
                    <template slot-scope="scope">
                        ...
                        >{{scope.row.dataStatus == '1' ? '发送成功' : '发送失败'}}</el-tag>
                    </template>
                </el-table-column>
            </el-table>
    ...
    data() {
        return {
            ...
            tableData: [{
                ...
                'areaCode': '86',
                'phone':'13711112222',
                'msg':'【coffee】您的登录验证码{123456}，5分钟过期，请注意保存',
                'msgid':'789688977856745645',
